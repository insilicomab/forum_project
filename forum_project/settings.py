...
SECRET_KEY = 'django-insecure-#=ainjr#!18@mfaj@crhv==slq7s495y6ca3u#$c$jjq9^r5oq'
...
MEDIA_URL = '/media/' # メディアファイルを公開する際の URL
MEDIA_ROOT = os.path.join (BASE_DIR, 'media') # ファイルの保存先

AUTH_USER_MODEL = 'accounts.Users' # カスタムユーザーモデルの設定